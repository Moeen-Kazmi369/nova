...
//   // Sidebar selection state: 'users' or 'models'
...
//     { id: 3, name: "Charlie Brown", email: "charlie@ex.com" },
//   ]);

//   // Models dummy data
//   const [models, setModels] = useState([
//     { id: 1, name: "Model Alpha", description: "First test AI model" },
//     { id: 2, name: "Model Beta", description: "Second version AI" },
//     { id: 3, name: "Model Gamma", description: "Latest RAG setup" },
//   ]);

//   // Modal state and selected user for delete
...
//                 <div
//                   key={model.id}
//                   className="bg-gray-800 rounded shadow p-4 cursor-pointer hover:bg-gray-700"
//                   onClick={() =>
//                     navigate(`/admin/dashboard/ai-model-config/${model.id}`)
//                   }
//                 >
